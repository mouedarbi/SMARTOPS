...
from .views import sync_portal_view, plugin_list_view, plugin_install_stream_view, plugin_uninstall_stream_view, api_check_sync
...
urlpatterns = [
    ...
    path('api/check-sync/', api_check_sync, name='api_check_sync'),
]
